...
{
private:
  mutable mutex mtx; // Add mutex for thread safety
...
public:
  ...
  void run()
  {
    ...
    while (running)
    {
      // ADMIN - USER CONTROL CONSOLE
      cout << "===========================================" << endl;
      cout << "         ADMIN & USER CONTROL PANEL        " << endl;
      cout << "===========================================" << endl;
...
int main()
{
  ...
  cout << endl;
  cout << "Refer to given instructions listed for system operator: " << endl
       << endl;
